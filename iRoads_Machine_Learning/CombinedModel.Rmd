...
json_data <- read_json("TrainData\\j7templeroadleftpothole1.json")
for (item in json_data){
  vector_index <- c(vector_index, i)
  vector_acceX <- c(vector_acceX, item$acceX)
  vector_acceY <- c(vector_acceY, item$acceY)
...
json_data <- read_json("TrainData\\j7templeroadleftpothole2.json")
for (item in json_data){
  vector_index <- c(vector_index, i)
  vector_acceX <- c(vector_acceX, item$acceX)
  vector_acceY <- c(vector_acceY, item$acceY)
...
json_data <- read_json("TrainData\\j7templeroadrightpothole1.json")
for (item in json_data){
  vector_index <- c(vector_index, i)
  vector_acceX <- c(vector_acceX, item$acceX)
  vector_acceY <- c(vector_acceY, item$acceY)
...
json_data <- read_json("TrainData\\j7templeroadrightpothole2.json")
for (item in json_data){
  vector_index <- c(vector_index, i)
  vector_acceX <- c(vector_acceX, item$acceX)
  vector_acceY <- c(vector_acceY, item$acceY)
...
combined_model <- randomForest(anomaly ~ ., data = data_set, importance = TRUE)
combined_model

json_data <- read_json("TestData\\j7Uduwila1.json")
vector_acceX <- numeric()
vector_acceY <- numeric()
vector_acceZ <- numeric()
vector_acceX_raw <- numeric()
...
pred <- predict(combined_model, test_data_set, type = "class")
...
write_json(result, "Prediction\\j7Uduwila1CombinedModel.json")
```{r}
